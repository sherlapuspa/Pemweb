...
echo "<div class='container p-2'>
                ...
                ";
            } else { echo "<div class='container p-2'>
                <div class='row no-gutters'>
                    <div class='col-lg-6 col-md-12 m-auto'>
                        <div class='alert alert-success fade show' role='alert'>
                            <button type='button' class='close' data-dismiss='alert' aria-label='Close'>
                        ...
                        <div class="card">
                            <div class="card-body">
                                ...
                                <div class="market-status-table mt-4">
										 ...
										 <table id="dataTable3" class="table table-hover"><thead class="thead-dark">
											...
											while($b=mysqli_fetch_array($brg)){
												...
												<tr>
                                                    ...
                                                    <td><button data-toggle="modal" data-target="#edit<?=$id;?>" class="btn btn-warning"><i class="ti-pencil-alt"></i> Edit</button> <button data-toggle="modal" data-target="#del<?=$id;?>" class="btn btn-danger"><i class="ti-trash"></i> Delete</button></td>
												</tr>
									...
									<a href="exportbrgmsk.php" target="_blank" class="btn btn-info"><i class="ti-printer"></i> Export Data</a>
                                </div>
                            </div>
                        </div>
                    </div>
